...
The tutorial is based on [Oliver's (2024)](https://jcoliver.github.io/learn-r/011-species-distribution-models) publication. However, we made major changes to the environmental data processing section as these data have different resolutions and coordinate reference systems.

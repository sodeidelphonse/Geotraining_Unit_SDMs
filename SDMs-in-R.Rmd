...
Then we project the vector data into *long/lat* reference system to match it with the reference system of Fogo Island map and bioclimatic layers. Note that the climate data available in long/lat projection system will be downloaded in the next section.
...
The ANOVA table show that the temperature seasonality, precipitation and land cover classes have a significant effect on the probability of presence of *B. bipinnata* in Fogo Island. This result aligns with the one obtained from the analyses carried out in the Module 2 on land cover classification where we notice a significant variation of the amount of introduced species among land cover classes. 

...
We used **RMarkdown**, a simple formatting syntax for authoring HTML, and MS Word and PDF documents (see <http://rmarkdown.rstudio.com>). So, when you click the **Knit** button, a document will be generated that includes both content and the output of any embedded R code chunks within the document.
